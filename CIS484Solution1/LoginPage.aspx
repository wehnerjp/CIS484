...
<body>
    ...
    <div CssClass="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
                    ...
                    <h2 class="title">Registration Form</h2>
                       <form id="form2" runat="server">
                        <div class="row row-space">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    <asp:Label ID="LastName" CssClass="label" runat="server" Text="First Name"></asp:Label>
                        ...
                        <div class="row row-space">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    <asp:Label ID="Gender" runat="server" CssClass="label" Text="Gender"></asp:Label>
                                    <div class="p-t-10">
                        ...
                        <div class="p-t-15">
                            <asp:Button ID="Button1" runat="server" Text="Login" CssClass="btn btn--radius-2 btn--blue"/>
                        </div>
                    </form>
                </div>
            </div>
